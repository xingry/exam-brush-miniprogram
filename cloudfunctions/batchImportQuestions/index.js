...
const baseQuestions = [
  ...
  },
  {
    ...
    categoryName: '计算机网络',
    type: 'single',
    question: 'FTP协议的默认控制端口是？',
    options: ['20', '21', '22', '23'],
    correctAnswer: 1,
    analysis: 'FTP控制连接使用21端口，数据连接使用20端口。'
  },
  // 计算机网络题 - 继续添加
  {
    category: 'network',
  ...
  },
  {
    ...
    options: ['分配带宽', '同步序列号', '验证密码', '压缩数据'],
    correctAnswer: 1,
    analysis: '三次握手用于同步双方的初始序列号，建立可靠连接。'
  },
  {
    category: 'network',
    categoryName: '计算机网络',
    type: 'single',
    question: '下列设备中，工作在物理层的是？',
    options: ['路由器', '交换机', '集线器', '网关'],
    correctAnswer: 2,
    analysis: '集线器工作在物理层，只进行信号的放大和转发。'
  },
  {
    category: 'network',
    categoryName: '计算机网络',
    type: 'single',
    question: 'SMTP协议用于？',
    options: ['接收邮件', '发送邮件', '网页浏览', '文件传输'],
    correctAnswer: 1,
    analysis: 'SMTP(简单邮件传输协议)用于发送邮件，POP3/IMAP用于接收邮件。'
  },
  {
    category: 'network',
    categoryName: '计算机网络',
    type: 'single',
    question: 'Tracert命令的作用是？',
    options: ['测试网速', '追踪路由路径', '查看配置', '检测病毒'],
    correctAnswer: 1,
    analysis: 'Tracert用于追踪数据包到达目标的路由路径。'
  },
...
exports.main = async (event, context) => {
  ...
  try {
    ...
    if (clear) {
      // 获取所有题目
      const { data } = await db.collection('questions').limit(500).get()
      // 批量删除
